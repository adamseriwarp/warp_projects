...
<html>
<head>
    <title>Top 75 CBSAs Color-Coded Map with Smart Corridors</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="controls">
        <h4>🎨 <span class="improvement-badge">COLOR-CODED</span> CBSA Analysis</h4>
        ...
        <div style="background: #e3f2fd; padding: 8px; border-radius: 4px; font-size: 12px; margin: 10px 0;">
            <strong>🎨 COLOR-CODED Features:</strong><br>
    ...
    <div class="legend">
        <h4>🎨 Top 75 CBSAs Color-Coded Map</h4>
    ...
    <script>
        ...
        console.log('🎨 COLOR-CODED CBSA Map loaded with:');
        ...
        function calculateSmartCorridors(maxCorridorDistance, baseCorridorWidth) {{
            ...
            filteredNonCbsaZips.forEach(targetZip => {{
                ...
                if (nearestCbsaCentroid) {{
                    console.log('   🛣️  Creating corridor:', targetZip.properties.zipcode_clean, '→ CBSA', nearestCbsaCentroid.cbsa_name, '(' + minDistance.toFixed(1) + ' mi, width: ' + dynamicWidth.toFixed(1) + ' mi)');
    ...
    # Add final JavaScript functions and event handlers
    html_content += """
        ...
        function exportFilteredData() {
            ...
            if (document.getElementById('showSmartCorridors').checked) {
                ...
                console.log('Export: Found', corridorZipCodes.size, 'corridor zip codes');
            }
            ...
            a.setAttribute('download', 'cbsa_color_coded_filtered_zip_codes_' + new Date().toISOString().slice(0, 19).replace(/:/g, '-') + '.csv');
...
def main():
    ...
    print("🎨 Starting COLOR-CODED CBSA Map with Smart Corridor Analysis...")
    ...
    # Save the HTML file
    output_file = BASE_DIR / 'cbsa_color_coded_corridor_map.html'
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)

    print(f"✅ COLOR-CODED CBSA Map generated successfully!")
    ...
    print("\n🎨 COLOR-CODED Features Summary:")
    print("✅ Each CBSA has a unique color for easy distinction")
    print("✅ No quote density heat mapping - cleaner visualization")
    print("✅ Red color for non-CBSA zip codes")
    print("✅ CBSA colors avoid red to prevent confusion")
    print("✅ All other functionality preserved (corridors, filtering, etc.)")
    print("✅ Smart corridor analysis with distance limits")
